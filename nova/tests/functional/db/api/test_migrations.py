...
class NovaAPIMigrationsWalk(test_migrations.WalkVersionsMixin):
    ...
    def _check_004(self, engine, data):
        # flavors
        for column in ['created_at', 'updated_at', 'deleted_at', 'name', 'id',
            'memory_mb', 'vcpus', 'swap', 'vcpu_weight', 'flavorid',
            'rxtx_factor', 'root_gb', 'ephemeral_gb', 'disabled', 'is_public',
            'deleted']:
        ...
        # flavor_extra_specs
        for column in ['created_at', 'updated_at', 'deleted_at', 'id',
            'flavor_id', 'key', 'value', 'deleted']:
